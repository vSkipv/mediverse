...
class PredictionModelsScreen2 extends StatefulWidget {
  @override
  _PredictionModelsScreenState createState() => _PredictionModelsScreenState();
}

class _PredictionModelsScreenState extends State<PredictionModelsScreen2> {
  File? _selectedImage;
